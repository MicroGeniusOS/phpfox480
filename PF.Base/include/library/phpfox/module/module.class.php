...
class Phpfox_Module
{
    ...
    private function _cacheModuleBlocks()
    {
        ...
        if ((false === ($this->_aModuleBlocks = $oCache->getLocalFirst($iBlockCacheId)))
            ...
            $aRows = Phpfox_Database::instance()
                ->select('b.block_id, b.title, b.type_id, b.ordering, b.m_connection, b.component, b.location, b.disallow_access, b.can_move, m.module_id, bs.source_parsed, bs.source_code, b.params')
