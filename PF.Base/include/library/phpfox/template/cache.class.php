    ...
    private function _parseFunction($sFunction, $sModifiers, $sArguments, $bKeepOriginalOnError = false)
    {
        switch ($sFunction) {
            ...
            case 'select_date':
                ...
                $aSep = '<span class="field_separator">' . (isset($aArgs['field_separator']) ? $this->_removeQuote($aArgs['field_separator']) : '') . '</span>';
                ...
                if ($bUseJquery) {
                    ...
                    $sReturn = '<div class="js_datepicker_core' . (isset($aArgs['id']) ? str_replace(array('"', "'"), '', $aArgs['id']) : '') . '"><span class="js_datepicker_holder"><div style="display:none;">' . $sReturn . '</div>' . $sInput . '<div class="js_datepicker_image"></div></span> ';
                }
