...
class Phpfox
{
    ...
    public static function run()
    {
        ...
        } else if (self::demoModeActive() && Phpfox::isAdmin() && strtolower(Phpfox_Request::instance()->get('req1')) !== 'flavors') {
        ...
        if (!self::isAdminPanel()) {
            ...
            if (defined('PHPFOX_IS_PAGES_VIEW') && defined('PHPFOX_PAGES_ITEM_TYPE')) {
                ...
                $sPageUrl = Phpfox_Request::instance()->get('req1');
                $sModule = (in_array($sPageUrl, [$sSection, $sRewrittenSection]) ? Phpfox_Request::instance()->get('req3') : Phpfox_Request::instance()->get('req2'));
                    ...
                    foreach ($aBlocks as $aBlock) {
                        if (is_array($aBlock)) {
                            if (isset($aBlock['type_id']) && $aBlock['type_id'] == 0) {
                                ...
                                if (isset($aBlock['type_id']) && $aBlock['type_id'] == 1) {
                                    \Phpfox::getBlock([$aBlock['component']], $aBlock['params']);
                                } else {
                                    if (isset($aBlock['type_id']) && $aBlock['type_id'] == 2) {
                                        \Phpfox::getBlock([$aBlock['component']], $aBlock['params']);
                                    } else {
