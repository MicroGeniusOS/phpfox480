...
Site Name</setting>
        <setting group="mail" module_id="core" is_hidden="0" type="boolean" var_name="check_certificate_smtp_host_name" phrase_var_name="setting_check_certificate_smtp_host_name" ordering="5" version_id="4.6.1">1</setting>
  ...
  1 => '2|core.her|profile.female|core.herself|female',
		...
		<setting group="" module_id="core" is_hidden="0" type="password" var_name="ftp_password" phrase_var_name="ftp_password" ordering="5" version_id="4.2.0">password</setting>
		<setting group="registration" module_id="core" is_hidden="0" type="boolean" var_name="registration_sms_enable" phrase_var_name="setting_registration_sms_enable" ordering="22" version_id="4.3.0">0</setting>
		<setting group="registration" module_id="core" is_hidden="0" type="drop" var_name="registration_sms_service" phrase_var_name="setting_registration_sms_service" ordering="23" version_id="4.3.0"><![CDATA[a:2:{s:7:"default";s:5:"nexmo";s:6:"values";a:3:{i:0;s:5:"nexmo";i:1;s:6:"twilio";i:2;s:10:"clickatell";}}]]></setting>
		<setting group="registration" module_id="core" is_hidden="0" type="string" var_name="nexmo_api_key" phrase_var_name="setting_nexmo_api_key" ordering="24" version_id="4.3.0" />
		<setting group="registration" module_id="core" is_hidden="0" type="string" var_name="nexmo_api_secret" phrase_var_name="setting_nexmo_api_secret" ordering="25" version_id="4.3.0" />
        <setting group="registration" module_id="core" is_hidden="0" type="string" var_name="nexmo_phone_number" phrase_var_name="setting_nexmo_phone_number" ordering="26" version_id="4.3.0" />
		<setting group="registration" module_id="core" is_hidden="0" type="string" var_name="twilio_account_id" phrase_var_name="setting_twilio_account_id" ordering="27" version_id="4.3.0" />
		<setting group="registration" module_id="core" is_hidden="0" type="string" var_name="twilio_auth_token" phrase_var_name="setting_twilio_auth_token" ordering="28" version_id="4.3.0" />
		<setting group="registration" module_id="core" is_hidden="0" type="string" var_name="twilio_phone_number" phrase_var_name="setting_twilio_phone_number" ordering="29" version_id="4.3.0" />
		<setting group="registration" module_id="core" is_hidden="0" type="string" var_name="clickatell_api_key" phrase_var_name="setting_clickatell_api_key" ordering="30" version_id="4.6.0" />
		...
		<setting group="" module_id="core" is_hidden="0" type="integer" var_name="crop_seo_url" phrase_var_name="setting_crop_seo_url" ordering="6" version_id="2.0.0alpha1">75</setting>
		<setting group="" module_id="core" is_hidden="0" type="integer" var_name="shorten_parsed_url_links" phrase_var_name="setting_shorten_parsed_url_links" ordering="2" version_id="2.0.0alpha3">50</setting>
		...
		<setting group="" module_id="core" is_hidden="0" type="large_string" var_name="words_remove_in_keywords" phrase_var_name="setting_words_remove_in_keywords" ordering="4" version_id="2.0.0rc1">and, i, in</setting>
        ...
        <setting group="" module_id="core" is_hidden="0" type="boolean" var_name="no_follow_on_external_links" phrase_var_name="setting_no_follow_on_external_links" ordering="7" version_id="3.3.0beta1">0</setting>
		<setting group="" module_id="core" is_hidden="0" type="boolean" var_name="include_site_title_all_pages" phrase_var_name="setting_include_site_title_all_pages" ordering="8" version_id="3.6.0rc1">0</setting>
        ...
        <setting group="" module_id="core" is_hidden="1" type="large_string" var_name="global_admincp_note" phrase_var_name="setting_global_admincp_note" ordering="1" version_id="2.0.0rc1" />
        ...
        <!-- new settings in 4.7.0 -->
        <setting group="general" module_id="core" is_hidden="0" type="drop" var_name="start_of_week" phrase_var_name="setting_start_of_week" ordering="18" version_id="4.7.0"><![CDATA[a:2:{s:7:"default";s:3:"mon";s:6:"values";a:7:{i:0;s:3:"sun";i:1;s:3:"mon";i:2;s:3:"tue";i:3;s:3:"wed";i:4;s:3:"thu";i:5;s:3:"fri";i:6;s:3:"sat";}}]]></setting>
        <setting group="general" module_id="core" is_hidden="0" type="integer" var_name="min_character_to_search" phrase_var_name="setting_min_character_to_search" ordering="19" version_id="4.7.0">2</setting>
        <setting group="general" module_id="core" is_hidden="0" type="integer" var_name="no_pages_for_scroll_down" phrase_var_name="setting_no_pages_for_scroll_down" ordering="2" version_id="4.7.0">2</setting>
	</settings>
	<blocks>
		<block type_id="0" m_connection="admincp.index" module_id="core" component="note" location="3" is_active="1" ordering="2" disallow_access="" can_move="1">
        ...
        <block type_id="0" m_connection="admincp.index" module_id="core" component="news-slide" location="6" is_active="1" ordering="3" disallow_access="" can_move="1">
	...
	<components>
		...
		<component module_id="core" component="news-slide" m_connection="" module="core" is_controller="0" is_block="1" is_active="1" />
		<component module_id="core" component="gmap-block" m_connection="" module="core" is_controller="0" is_block="1" is_active="1" />
	</components>
	<crons>
...
<br class="pf_break" />Sed dignissim convallis interdum. Curabitur ligula ligula, lacinia in accumsan at, pharetra tempor sapien. Quisque quis augue ac magna aliquet fermentum ultrices vitae mauris. Phasellus nec dolor hendrerit dolor vestibulum placerat nec ut lacus. Phasellus mattis suscipit varius. Ut egestas tortor sit amet augue cursus ut volutpat magna scelerisque. Aenean pulvinar, lacus a hendrerit gravida, tellus neque condimentum lorem, eget semper purus massa eget neque. Nam pretium lacus in quam feugiat fringilla aliquet lectus egestas. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Pellentesque elementum consequat feugiat. Quisque id diam justo, eget euismod augue. Integer tristique vestibulum sollicitudin. Quisque eu orci nec magna vestibulum placerat in volutpat odio. Integer in orci non dolor ornare viverra. Nulla facilisi. Fusce volutpat mollis urna, vel ultrices libero porttitor a.]]></text_parsed>
	...
	<install><![CDATA[		
        ...
        $this->database()->addField([
            'table' => Phpfox::getT('country'),
            'field' => 'is_active',
            'type'  => 'BOOL',
            'default' => '1',
            'null' => true
