$Core.Gmap = {
  ...
  initGoogle: function (sCallback, oCallbackParams) {
    ...
    if (this.isGoogleReady || typeof google !== 'undefined') {
  ...
  initMapView: function (oParams) {
    try {
      ...
      if (navigator.geolocation) {
        ...
        this.handleLocationError(false, infoWindow, $Core.Gmap.oMap.getCenter());
      }
  ...
  getCurrentLocation: function () {
    ...
    navigator.geolocation.getCurrentPosition(function (position) {
      ...
      $Core.Gmap.handleLocationError(true, infoWindow, $Core.Gmap.oMap.getCenter());
