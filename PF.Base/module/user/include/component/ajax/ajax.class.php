...
class User_Component_Ajax_Ajax extends Phpfox_Ajax
{
    ...
    public function getRegistrationStep()
    {
        ...
        $oValid = Phpfox_Validator::instance()->set(['sFormName' => 'js_form', 'aParams' => Phpfox::getService('user.register')->getValidation($this->get('step'), false, $iUserGroupId, true)]);
    ...
    public function cropPhoto()
    {
        ...
        if ($this->get('in_process')) {
            ...
            if ($iNotCompleted) {
                ...
                (Phpfox::isModule('feed') ? Phpfox::getService('feed.process')->add('user_photo', Phpfox::getUserId(), serialize(['destination' => $sFileName, 'server_id' => $iServerId])) : null);
    ...
    public function addInactiveJob()
    {
        ...
        if ($iId = Phpfox::getService('user.process')->addInactiveJob((array)$iUserId, $bSendAll, $iDays)) {
