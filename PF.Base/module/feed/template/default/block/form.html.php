    ...
    <div class="activity_feed_form_button">
      <div class="activity_feed_form_button_status_info">
        ...
        <div id="js_location_input">
            <a class="btn btn-danger pr-4" href="#" title="{_p var='close'}" onclick="$Core.FeedPlace.cancelCheckIn('', true); return false;"><i class="fa fa-eye-slash"></i></a>
